...
import com.winit.generator.framework.task.TaskFactory;
...
public class Application {
    ...
    private void workWithoutCallback() {
        ...
        long executeTime = DateUtil.calExcuteSecondTime(startTime, endTime);
        logger.info("应用程序{}执行总耗时(秒)：{},总耗时(毫秒):{}", this.applicationName, executeTime, DateUtil.calExcuteMilliTime(startTime, endTime));
    }
